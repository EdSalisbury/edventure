...
str_verb_claws                dta c'CLAWS',$FF
str_verb_hits                 dta c'HITS',$FF
str_verbs_stings              dta c'STINGS',$FF
str_verbs_breathes_ice        dta c'BREATHES ICE',$FF
str_verbs_breathes_acid       dta c'BREATHES ACID',$FF
str_verbs_breathes_lightning  dta c'BREATHES LIGHTNING',$FF
str_verbs_breathes_fire       dta c'BREATHES FIRE',$FF

; Player attack string fragments
str_you_hit   dta d'YOU HIT THE ',$FF
str_you_miss  dta d'YOU MISS THE ',$FF

; Attack string fragments
str_for        dta d' FOR ',$FF
str_damage     dta d' DAMAGE!',$FF
str_misses_you dta d' MISSES YOU!',$FF